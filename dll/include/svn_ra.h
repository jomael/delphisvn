 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API const svn_version_t *svn_ra_version(void);
 ...
 * @since New in 1.3.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_open2(svn_ra_session_t **session_p,
 ...
 * @deprecated Provided for backward compatibility with the 1.2 API.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_open(svn_ra_session_t **session_p,
                         const char *repos_URL,
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_reparent(svn_ra_session_t *ra_session,
                             const char *url,
                             apr_pool_t *pool);
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_get_latest_revnum(svn_ra_session_t *session,
                                      svn_revnum_t *latest_revnum,
                                      apr_pool_t *pool);
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_get_dated_revision(svn_ra_session_t *session,
                                       svn_revnum_t *revision,
                                       apr_time_t tm,
                                       apr_pool_t *pool);
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_change_rev_prop(svn_ra_session_t *session,
                                    svn_revnum_t rev,
                                    const char *name,
                                    const svn_string_t *value,
                                    apr_pool_t *pool);
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_rev_proplist(svn_ra_session_t *session,
                                 svn_revnum_t rev,
                                 apr_hash_t **props,
                                 apr_pool_t *pool);
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_rev_prop(svn_ra_session_t *session,
                             svn_revnum_t rev,
                             const char *name,
                             svn_string_t **value,
                             apr_pool_t *pool);
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_get_commit_editor2(svn_ra_session_t *session,
 ...
 */ 
LIBSVN_CLIENT_API svn_error_t *svn_ra_get_commit_editor(svn_ra_session_t *session,
                                      const svn_delta_editor_t **editor,
                                      void **edit_baton,
                                      const char *log_msg,
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_get_file(svn_ra_session_t *session,
                             const char *path,
                             svn_revnum_t revision,
                             svn_stream_t *stream,
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_get_dir2(svn_ra_session_t *session,
                             apr_hash_t **dirents,
                             svn_revnum_t *fetched_rev,
                             apr_hash_t **props,
                             const char *path,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_get_dir(svn_ra_session_t *session,
                            const char *path,
                            svn_revnum_t revision,
                            apr_hash_t **dirents,
                            svn_revnum_t *fetched_rev,
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_do_update(svn_ra_session_t *session,
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_do_switch(svn_ra_session_t *session,
                              const svn_ra_reporter2_t **reporter,
                              void **report_baton,
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_do_status(svn_ra_session_t *session,
                              const svn_ra_reporter2_t **reporter,
                              void **report_baton,
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_do_diff2(svn_ra_session_t *session,
                             const svn_ra_reporter2_t **reporter,
                             void **report_baton,
                             svn_revnum_t revision,
 ...
 * @deprecated Provided for backward compatibility with the 1.3 API.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_do_diff(svn_ra_session_t *session,
                            const svn_ra_reporter2_t **reporter,
                            void **report_baton,
                            svn_revnum_t revision,
                            const char *diff_target,
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_get_log(svn_ra_session_t *session,
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_check_path(svn_ra_session_t *session,
                               const char *path,
                               svn_revnum_t revision,
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_stat(svn_ra_session_t *session,
                         const char *path,
                         svn_revnum_t revision,
                         svn_dirent_t **dirent,
                         apr_pool_t *pool);
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_get_uuid(svn_ra_session_t *session,
                             const char **uuid,
                             apr_pool_t *pool);
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_get_repos_root(svn_ra_session_t *session,
                                   const char **url,
                                   apr_pool_t *pool);
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_get_locations(svn_ra_session_t *session,
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_get_file_revs(svn_ra_session_t *session,
                                  const char *path,
                                  svn_revnum_t start,
                                  svn_revnum_t end,
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_lock(svn_ra_session_t *session,
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_unlock(svn_ra_session_t *session,
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_get_lock(svn_ra_session_t *session,
                             svn_lock_t **lock,
                             const char *path,
                             apr_pool_t *pool);
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_get_locks(svn_ra_session_t *session,
                              apr_hash_t **locks,
                              const char *path,
                              apr_pool_t *pool);
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_replay(svn_ra_session_t *session,
                           svn_revnum_t revision,
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_print_modules(svn_stringbuf_t *output,
                                  apr_pool_t *pool);
 ...
 * @deprecated Provided for backward compatibility with the 1.1 API.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_print_ra_libraries(svn_stringbuf_t **descriptions,
                                       void *ra_baton,
                                       apr_pool_t *pool);
 ...
 *
 * @deprecated Provided for backward compatibility with the 1.1 API. */
LIBSVN_CLIENT_API svn_error_t * svn_ra_dav_init(int abi_version,
                              apr_pool_t *pool,
                              apr_hash_t *hash);
 ...
 *
 * @deprecated Provided for backward compatibility with the 1.1 API. */
LIBSVN_CLIENT_API svn_error_t * svn_ra_local_init(int abi_version,
                                apr_pool_t *pool,
                                apr_hash_t *hash);
 ...
 *
 * @deprecated Provided for backward compatibility with the 1.1 API. */
LIBSVN_CLIENT_API svn_error_t * svn_ra_svn_init(int abi_version,
                              apr_pool_t *pool,
                              apr_hash_t *hash);
 ...
 * @since New in 1.4.
 * @deprecated Provided for backward compatibility with the 1.1 API. */
LIBSVN_CLIENT_API svn_error_t * svn_ra_serf_init(int abi_version,
                               apr_pool_t *pool,
                               apr_hash_t *hash);
 ...
 * @deprecated Provided for backward compatibility with the 1.1 API.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_init_ra_libs(void **ra_baton, apr_pool_t *pool);
 ...
 * @deprecated Provided for backward compatibility with the 1.1 API.
 */
LIBSVN_CLIENT_API svn_error_t *svn_ra_get_ra_library(svn_ra_plugin_t **library,
                                   void *ra_baton,
                                   const char *url,
                                   apr_pool_t *pool);
