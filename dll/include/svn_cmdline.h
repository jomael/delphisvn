 ...
 */
LIBSVN_CLIENT_API int svn_cmdline_init (const char *progname, FILE *error_stream);


/** Set @a *dest to an output-encoded C string from UTF-8 C string @a
 * src; allocate @a *dest in @a pool.
 */
LIBSVN_CLIENT_API svn_error_t *svn_cmdline_cstring_from_utf8 (const char **dest,
                                            const char *src,
                                            apr_pool_t *pool);

/** Like svn_utf_cstring_from_utf8_fuzzy(), but converts to an
 * output-encoded C string. */
LIBSVN_CLIENT_API const char *svn_cmdline_cstring_from_utf8_fuzzy (const char *src,
                                                 apr_pool_t *pool);

/** Set @a *dest to a UTF-8-encoded C string from input-encoded C
 * string @a src; allocate @a *dest in @a pool.
 */
LIBSVN_CLIENT_API svn_error_t * svn_cmdline_cstring_to_utf8 (const char **dest,
                                           const char *src,
                                           apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_cmdline_path_local_style_from_utf8 (const char **dest,
                                                     const char *src,
                                                     apr_pool_t *pool);
 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API svn_error_t *svn_cmdline_printf (apr_pool_t *pool,
                                 const char *fmt,
                                 ...)
 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API svn_error_t *svn_cmdline_fprintf (FILE *stream,
                                  apr_pool_t *pool,
                                  const char *fmt,
                                  ...)
 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API svn_error_t *svn_cmdline_fputs (const char *string,
                                FILE *stream,
                                apr_pool_t *pool);
 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API svn_error_t *svn_cmdline_fflush (FILE *stream);
 ...
 * @since New in 1.3.
 */
LIBSVN_CLIENT_API const char *svn_cmdline_output_encoding (apr_pool_t *pool);
 ...
 * @since New in 1.3.
 */
LIBSVN_CLIENT_API int svn_cmdline_handle_exit_error (svn_error_t *error,
                                   apr_pool_t *pool,
                                   const char *prefix);
