 ...
 * @since New in 1.4.
 */  
LIBSVN_CLIENT_API const svn_opt_subcommand_desc2_t *
 ...
 * @deprecated Provided for backward compatibility with the 1.3 API.
 */  
LIBSVN_CLIENT_API const svn_opt_subcommand_desc_t *
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API const apr_getopt_option_t *
 ...
 */
LIBSVN_CLIENT_API int svn_opt_parse_revision(svn_opt_revision_t *start_revision,
 ...
 */
LIBSVN_CLIENT_API void svn_opt_push_implicit_dot_target(apr_array_header_t *targets,
                                      apr_pool_t *pool);
