 ...
 * category.  
 */
LIBSVN_CLIENT_API svn_error_t *svn_config_get_config(apr_hash_t **cfg_hash,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_config_read(svn_config_t **cfgp,
                             const char *file,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_config_merge(svn_config_t *cfg,
                              const char *file,
                              svn_boolean_t must_exist);
 ...
 */
LIBSVN_CLIENT_API void svn_config_get(svn_config_t *cfg, const char **valuep,
 ...
 */
LIBSVN_CLIENT_API void svn_config_set(svn_config_t *cfg,
                    const char *section, const char *option,
                    const char *value);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_config_get_bool(svn_config_t *cfg, svn_boolean_t *valuep,
                                 const char *section, const char *option,
 ...
 */
LIBSVN_CLIENT_API void svn_config_set_bool(svn_config_t *cfg,
                         const char *section, const char *option,
                         svn_boolean_t value);
 ...
 * @deprecated Provided for backwards compatibility with the 1.2 API. 
 */
LIBSVN_CLIENT_API int svn_config_enumerate_sections(svn_config_t *cfg, 
 ...
 * @since New in 1.3.
 */
LIBSVN_CLIENT_API int svn_config_enumerate_sections2(svn_config_t *cfg, 
 ...
 * @deprecated Provided for backwards compatibility with the 1.2 API. 
 */
LIBSVN_CLIENT_API int svn_config_enumerate(svn_config_t *cfg, const char *section,
 ...
 * @since New in 1.3.
 */
LIBSVN_CLIENT_API int svn_config_enumerate2(svn_config_t *cfg, const char *section,
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API svn_boolean_t svn_config_has_section(svn_config_t *cfg, const char *section);
 ...
 */
LIBSVN_CLIENT_API const char *svn_config_find_group(svn_config_t *cfg, const char *key,
 ...
 */
LIBSVN_CLIENT_API const char *svn_config_get_server_setting(svn_config_t *cfg,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_config_get_server_setting_int(svn_config_t *cfg,
                                               const char *server_group,
                                               const char *option_name,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_config_ensure(const char *config_dir, apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t * svn_config_read_auth_data(apr_hash_t **hash,
 ...
 * <tt>svn_string_t *</tt> values.
 */
LIBSVN_CLIENT_API svn_error_t * svn_config_write_auth_data(apr_hash_t *hash,
                                         const char *cred_kind,
                                         const char *realmstring,
                                         const char *config_dir,
                                         apr_pool_t *pool);
