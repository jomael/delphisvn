 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API svn_dirent_t *svn_dirent_dup(const svn_dirent_t *dirent,
                             apr_pool_t *pool);
 ...
 * @since New in 1.3.
 */
LIBSVN_CLIENT_API svn_commit_info_t *
 ...
 * @since New in 1.3.
 */
LIBSVN_CLIENT_API svn_log_changed_path_t *
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API void svn_compat_wrap_commit_callback(svn_commit_callback2_t *callback2,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_mime_type_validate(const char *mime_type,
                                    apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_boolean_t svn_mime_type_is_binary(const char *mime_type);
