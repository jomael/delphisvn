 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API const svn_version_t *svn_diff_version(void);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_diff_diff(svn_diff_t **diff,
                           void *diff_baton,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_diff_diff3(svn_diff_t **diff,
                            void *diff_baton,
                            const svn_diff_fns_t *diff_fns,
                            apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_diff_diff4(svn_diff_t **diff,
                            void *diff_baton,
                            const svn_diff_fns_t *diff_fns,
                            apr_pool_t *pool);
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API svn_diff_file_options_t *
