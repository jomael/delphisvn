 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_check_path(const char *path,
                               svn_node_kind_t *kind,
                               apr_pool_t *pool);
 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_check_special_path(const char *path,
                                       svn_node_kind_t *kind,
...
LIBSVN_CLIENT_API svn_error_t *svn_io_check_resolved_path(const char *path,
                                        svn_node_kind_t *kind,
                                        apr_pool_t *pool);
 ...
 *
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_open_unique_file2(apr_file_t **f,
 ...
 *
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_open_unique_file(apr_file_t **f,
                                     const char **unique_name_p,
                                     const char *path,
                                     const char *suffix,
 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_create_unique_link(const char **unique_name_p,
                                       const char *path,
                                       const char *dest,
                                       const char *suffix,
                                       apr_pool_t *pool);
 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_read_link(svn_string_t **dest,
                              const char *path,
                              apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_temp_dir(const char **dir,
                             apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_copy_file(const char *src,
                              const char *dst,
 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_copy_link(const char *src,
                              const char *dst,
                              apr_pool_t *pool);
 ...
 */ 
LIBSVN_CLIENT_API svn_error_t *svn_io_copy_dir_recursively(const char *src,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_make_dir_recursively(const char *path, apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_append_file(const char *src,
                                const char *dst,
                                apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_set_file_read_only(const char *path,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_set_file_read_write(const char *path,
                                        svn_boolean_t ignore_enoent,
                                        apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_set_file_read_write_carefully(const char *path,
 ...
 * file doesn't exist.
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_set_file_executable(const char *path,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_is_file_executable(svn_boolean_t *executable, 
                                       const char *path, 
                                       apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_file_affected_time(apr_time_t *apr_time,
                                       const char *path,
                                       apr_pool_t *pool);
 ...
 * on Unix, and the last write time on Windows.
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_set_file_affected_time(apr_time_t apr_time,
                                           const char *path,
                                           apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_filesizes_different_p(svn_boolean_t *different_p,
                                          const char *file1,
                                          const char *file2,
                                          apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_file_checksum(unsigned char digest[],
                                  const char *file,
                                  apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_files_contents_same_p(svn_boolean_t *same,
                                          const char *file1,
                                          const char *file2,
                                          apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_file_create(const char *file,
                                const char *contents,
                                apr_pool_t *pool);
 ...
 * @deprecated Provided for backward compatibility with the 1.0 API.
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_file_lock(const char *lock_file,
 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_file_lock2(const char *lock_file,
                               svn_boolean_t exclusive,
 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_file_flush_to_disk(apr_file_t *file,
                                       apr_pool_t *pool);

/** Copy file @a file from location @a src_path to location @a dest_path.
 * Use @a pool for memory allocations.
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_dir_file_copy(const char *src_path, 
...
LIBSVN_CLIENT_API svn_stream_t *svn_stream_create(void *baton, apr_pool_t *pool);

/** Set @a stream's baton to @a baton */
LIBSVN_CLIENT_API void svn_stream_set_baton(svn_stream_t *stream, void *baton);

/** Set @a stream's read function to @a read_fn */
LIBSVN_CLIENT_API void svn_stream_set_read(svn_stream_t *stream, svn_read_fn_t read_fn);

/** Set @a stream's write function to @a write_fn */
LIBSVN_CLIENT_API void svn_stream_set_write(svn_stream_t *stream, svn_write_fn_t write_fn);

/** Set @a stream's close function to @a close_fn */
LIBSVN_CLIENT_API void svn_stream_set_close(svn_stream_t *stream, svn_close_fn_t close_fn);


/** Create a stream that is empty for reading and infinite for writing. */
LIBSVN_CLIENT_API svn_stream_t *svn_stream_empty(apr_pool_t *pool);
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API svn_stream_t *svn_stream_disown(svn_stream_t *stream, apr_pool_t *pool);
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API svn_stream_t * svn_stream_from_aprfile2(apr_file_t *file,
 ...
 * @deprecated Provided for backward compatibility with the 1.3 API.
 */
LIBSVN_CLIENT_API svn_stream_t *svn_stream_from_aprfile(apr_file_t *file, apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_stream_for_stdout(svn_stream_t **out, apr_pool_t *pool);

/** Return a generic stream connected to stringbuf @a str.  Allocate the
 * stream in @a pool.
 */
LIBSVN_CLIENT_API svn_stream_t *svn_stream_from_stringbuf(svn_stringbuf_t *str,
                                        apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_stream_t *svn_stream_compressed(svn_stream_t *stream, 
                                    apr_pool_t *pool);
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API svn_stream_t *svn_stream_checksummed(svn_stream_t *stream,
...
LIBSVN_CLIENT_API svn_error_t *svn_stream_read(svn_stream_t *stream, char *buffer,
                             apr_size_t *len);

/** Write to a generic stream. @see svn_stream_t. */
LIBSVN_CLIENT_API svn_error_t *svn_stream_write(svn_stream_t *stream, const char *data,
                              apr_size_t *len);

/** Close a generic stream. @see svn_stream_t. */
LIBSVN_CLIENT_API svn_error_t *svn_stream_close(svn_stream_t *stream);


/** Write to @a stream using a printf-style @a fmt specifier, passed through
 * apr_psprintf() using memory from @a pool.
 */
LIBSVN_CLIENT_API svn_error_t *svn_stream_printf(svn_stream_t *stream,
                               apr_pool_t *pool,
                               const char *fmt,
                               ...)
 ...
 * @since New in 1.3.
 */
LIBSVN_CLIENT_API svn_error_t *svn_stream_printf_from_utf8(svn_stream_t *stream,
                                         const char *encoding,
                                         apr_pool_t *pool,
                                         const char *fmt,
                                         ...)
 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API svn_error_t *svn_stream_copy(svn_stream_t *from, svn_stream_t *to,
                             apr_pool_t *pool);
 ...
 * reliably?
 */
LIBSVN_CLIENT_API svn_error_t *svn_stringbuf_from_file(svn_stringbuf_t **result, 
                                     const char *filename, 
                                     apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_stringbuf_from_aprfile(svn_stringbuf_t **result,
                                        apr_file_t *file,
                                        apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_remove_file(const char *path, apr_pool_t *pool);

/** Recursively remove directory @a path.  @a path is utf8-encoded. */
LIBSVN_CLIENT_API svn_error_t *svn_io_remove_dir(const char *path, apr_pool_t *pool);
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_get_dir_filenames(apr_hash_t **dirents,
                                      const char *path,
                                      apr_pool_t *pool);
 ...
 * @since New in 1.3.
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_get_dirents2(apr_hash_t **dirents,
                                 const char *path,
                                 apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_get_dirents(apr_hash_t **dirents,
                                const char *path,
                                apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_dir_walk(const char *dirname,
                             apr_int32_t wanted,
 ...
 * @since New in 1.3.
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_start_cmd(apr_proc_t *cmd_proc,
                              const char *path,
                              const char *cmd,
 ...
 * @since New in 1.3.
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_wait_for_cmd(apr_proc_t *cmd_proc,
                                 const char *cmd,
                                 int *exitcode,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_run_cmd(const char *path,
                            const char *cmd,
                            const char *const *args,
                            int *exitcode,
                            apr_exit_why_e *exitwhy,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_run_diff(const char *dir,
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_run_diff3_2(int *exitcode,
                                const char *dir,
                                const char *mine,
                                const char *older,
                                const char *yours,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_run_diff3(const char *dir,
                              const char *mine,
                              const char *older,
                              const char *yours,
                              const char *mine_label,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_io_detect_mimetype(const char **mimetype,
                                    const char *file,
                                    apr_pool_t *pool);
