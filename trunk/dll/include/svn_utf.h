 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API void svn_utf_initialize(apr_pool_t *pool);

/** Set @a *dest to a utf8-encoded stringbuf from native stringbuf @a src;
 * allocate @a *dest in @a pool.
 */
LIBSVN_CLIENT_API svn_error_t *svn_utf_stringbuf_to_utf8(svn_stringbuf_t **dest,
 ...
 * @a *dest in @a pool.
 */
LIBSVN_CLIENT_API svn_error_t *svn_utf_string_to_utf8(const svn_string_t **dest,
 ...
 * allocate @a *dest in @a pool.
 */
LIBSVN_CLIENT_API svn_error_t *svn_utf_cstring_to_utf8(const char **dest,
                                     const char *src,
                                     apr_pool_t *pool);
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API svn_error_t *svn_utf_cstring_to_utf8_ex2(const char **dest,
                                         const char *src,
                                         const char *frompage,
                                         apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_utf_cstring_to_utf8_ex(const char **dest,
                                        const char *src,
                                        const char *frompage,
 ...
 * allocate @a *dest in @a pool.
 */
LIBSVN_CLIENT_API svn_error_t *svn_utf_stringbuf_from_utf8(svn_stringbuf_t **dest,
                                         const svn_stringbuf_t *src,
                                         apr_pool_t *pool);
 ...
 * allocate @a *dest in @a pool.
 */
LIBSVN_CLIENT_API svn_error_t *svn_utf_string_from_utf8(const svn_string_t **dest,
                                      const svn_string_t *src,
                                      apr_pool_t *pool);
 ...
 * allocate @a *dest in @a pool.
 */
LIBSVN_CLIENT_API svn_error_t *svn_utf_cstring_from_utf8(const char **dest,
                                       const char *src,
                                       apr_pool_t *pool);
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API svn_error_t *svn_utf_cstring_from_utf8_ex2(const char **dest,
                                           const char *src,
                                           const char *topage,
                                           apr_pool_t *pool);
 ...
 * @deprecated Provided for backward compatibility with the 1.3 API.
 */
LIBSVN_CLIENT_API svn_error_t *svn_utf_cstring_from_utf8_ex(const char **dest,
                                          const char *src,
                                          const char *topage,
                                          const char *convset_key,
                                          apr_pool_t *pool);
 ...
 * details.
 */
LIBSVN_CLIENT_API const char *svn_utf_cstring_from_utf8_fuzzy(const char *src,
                                            apr_pool_t *pool);
 ...
 * allocate @a *dest in @a pool.
 */
LIBSVN_CLIENT_API svn_error_t *svn_utf_cstring_from_utf8_stringbuf(const char **dest,
                                                 const svn_stringbuf_t *src,
                                                 apr_pool_t *pool);
 ...
 * allocate @a *dest in @a pool.
 */
LIBSVN_CLIENT_API svn_error_t *svn_utf_cstring_from_utf8_string(const char **dest,
                                              const svn_string_t *src,
                                              apr_pool_t *pool);
