 ...
 */
LIBSVN_CLIENT_API int svn_sort_compare_items_as_paths (const svn_sort__item_t *a,
 ...
 */
LIBSVN_CLIENT_API int svn_sort_compare_items_lexically (const svn_sort__item_t *a,
                                      const svn_sort__item_t *b);
 ...
 * removing duplicates.
 */
LIBSVN_CLIENT_API int svn_sort_compare_revisions (const void *a, const void *b);
 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API int svn_sort_compare_paths (const void *a, const void *b);
