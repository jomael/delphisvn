 ...
 * @since New in 1.3.
 */
LIBSVN_CLIENT_API svn_auth_ssl_server_cert_info_t *
 ...
 * order.
 */
LIBSVN_CLIENT_API void svn_auth_open(svn_auth_baton_t **auth_baton,
 ...
 */
LIBSVN_CLIENT_API void svn_auth_set_parameter(svn_auth_baton_t *auth_baton,
                            const char *name,
                            const void *value);
 ...
 */
LIBSVN_CLIENT_API const void * svn_auth_get_parameter(svn_auth_baton_t *auth_baton,
                                    const char *name);
 ...
 */
LIBSVN_CLIENT_API svn_error_t * svn_auth_first_credentials(void **credentials,
 ...
 */
LIBSVN_CLIENT_API svn_error_t * svn_auth_next_credentials(void **credentials,
                                        svn_auth_iterstate_t *state,
                                        apr_pool_t *pool);
 ...
 * nothing.
 */
LIBSVN_CLIENT_API svn_error_t * svn_auth_save_credentials(svn_auth_iterstate_t *state,
                                        apr_pool_t *pool);
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API void svn_auth_get_username_prompt_provider
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API void svn_auth_get_simple_provider(svn_auth_provider_object_t **provider,
                                  apr_pool_t *pool);
 ...
 */
void
LIBSVN_CLIENT_API svn_auth_get_windows_simple_provider(svn_auth_provider_object_t **provider,
                                     apr_pool_t *pool);
#endif /* WIN32 || DOXYGEN */
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API void svn_auth_get_username_provider(svn_auth_provider_object_t **provider,
                                    apr_pool_t *pool);
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API void svn_auth_get_ssl_server_trust_file_provider
  (svn_auth_provider_object_t **provider,
   apr_pool_t *pool);
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API void svn_auth_get_ssl_client_cert_file_provider
  (svn_auth_provider_object_t **provider,
   apr_pool_t *pool);
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API void svn_auth_get_ssl_client_cert_pw_file_provider
  (svn_auth_provider_object_t **provider,
   apr_pool_t *pool);
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API void svn_auth_get_ssl_server_trust_prompt_provider
  (svn_auth_provider_object_t **provider,
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API void svn_auth_get_ssl_client_cert_prompt_provider
  (svn_auth_provider_object_t **provider,
 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API void svn_auth_get_ssl_client_cert_pw_prompt_provider
  (svn_auth_provider_object_t **provider,
