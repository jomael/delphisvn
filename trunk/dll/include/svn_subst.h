 ...
 * @since New in 1.4.
 */
LIBSVN_CLIENT_API svn_stream_t *
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_subst_translate_string(svn_string_t **new_value,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_subst_detranslate_string(svn_string_t **new_value,
                                          const svn_string_t *value,
