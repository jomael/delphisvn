 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API const svn_version_t *svn_repos_version (void);
 ...
 */
LIBSVN_CLIENT_API const char *svn_repos_find_root_path (const char *path,
                                      apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_open (svn_repos_t **repos_p,
                             const char *path,
                             apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_create (svn_repos_t **repos_p, 
                               const char *path,
                               const char *unused_1,
                               const char *unused_2,
                               apr_hash_t *config,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_delete (const char *path, apr_pool_t *pool);

/** Return the filesystem associated with repository object @a repos. */
LIBSVN_CLIENT_API svn_fs_t *svn_repos_fs (svn_repos_t *repos);
 ...
 * repository.
 */
LIBSVN_CLIENT_API svn_error_t * svn_repos_hotcopy (const char *src_path,
                                 const char *dst_path,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_recover (const char *path, apr_pool_t *pool);
 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_recover2 (const char *path,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_db_logfiles (apr_array_header_t **logfiles,
                                    const char *path,
...
LIBSVN_CLIENT_API const char *svn_repos_path (svn_repos_t *repos, apr_pool_t *pool);

/** Return the path to @a repos's Berkeley DB environment, allocated in
 * @a pool.
 */
LIBSVN_CLIENT_API const char *svn_repos_db_env (svn_repos_t *repos, apr_pool_t *pool);

/** Return path to @a repos's config directory, allocated in @a pool. */
LIBSVN_CLIENT_API const char *svn_repos_conf_dir (svn_repos_t *repos, apr_pool_t *pool);

/** Return path to @a repos's svnserve.conf, allocated in @a pool. */
LIBSVN_CLIENT_API const char *svn_repos_svnserve_conf (svn_repos_t *repos, apr_pool_t *pool);

/** Return path to @a repos's lock directory, allocated in @a pool. */
LIBSVN_CLIENT_API const char *svn_repos_lock_dir (svn_repos_t *repos, apr_pool_t *pool);

/** Return path to @a repos's db lockfile, allocated in @a pool. */
LIBSVN_CLIENT_API const char *svn_repos_db_lockfile (svn_repos_t *repos, apr_pool_t *pool);

/** Return path to @a repos's db logs lockfile, allocated in @a pool. */
LIBSVN_CLIENT_API const char *svn_repos_db_logs_lockfile (svn_repos_t *repos, apr_pool_t *pool);

/** Return the path to @a repos's hook directory, allocated in @a pool. */
LIBSVN_CLIENT_API const char *svn_repos_hook_dir (svn_repos_t *repos, apr_pool_t *pool);

/** Return the path to @a repos's start-commit hook, allocated in @a pool. */
LIBSVN_CLIENT_API const char *svn_repos_start_commit_hook (svn_repos_t *repos, apr_pool_t *pool);

/** Return the path to @a repos's pre-commit hook, allocated in @a pool. */
LIBSVN_CLIENT_API const char *svn_repos_pre_commit_hook (svn_repos_t *repos, apr_pool_t *pool);

/** Return the path to @a repos's post-commit hook, allocated in @a pool. */
LIBSVN_CLIENT_API const char *svn_repos_post_commit_hook (svn_repos_t *repos, apr_pool_t *pool);

/** Return the path to @a repos's pre-revprop-change hook, allocated in 
 * @a pool.
 */
LIBSVN_CLIENT_API const char *svn_repos_pre_revprop_change_hook (svn_repos_t *repos,
                                               apr_pool_t *pool);

/** Return the path to @a repos's post-revprop-change hook, allocated in 
 * @a pool.
 */
LIBSVN_CLIENT_API const char *svn_repos_post_revprop_change_hook (svn_repos_t *repos,
                                                apr_pool_t *pool);
...
LIBSVN_CLIENT_API const char *svn_repos_pre_lock_hook (svn_repos_t *repos, apr_pool_t *pool);

/** Return the path to @a repos's post-lock hook, allocated in @a pool. */
LIBSVN_CLIENT_API const char *svn_repos_post_lock_hook (svn_repos_t *repos, apr_pool_t *pool);

/** Return the path to @a repos's pre-unlock hook, allocated in @a pool. */
LIBSVN_CLIENT_API const char *svn_repos_pre_unlock_hook (svn_repos_t *repos, apr_pool_t *pool);

/** Return the path to @a repos's post-unlock hook, allocated in @a pool. */
LIBSVN_CLIENT_API const char *svn_repos_post_unlock_hook (svn_repos_t *repos, apr_pool_t *pool);
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_set_path2 (void *report_baton,
                                  const char *path,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_set_path (void *report_baton,
                                 const char *path,
                                 svn_revnum_t revision,
                                 svn_boolean_t start_empty,
                                 apr_pool_t *pool);
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_link_path2 (void *report_baton,
                                   const char *path,
 ...
 * @deprecated Provided for backward compatibility with the 1.1 API.
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_link_path (void *report_baton,
                                  const char *path,
                                  const char *link_path,
                                  svn_revnum_t revision,
                                  svn_boolean_t start_empty,
 ...
 * All temporary allocations are done in @a pool.
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_delete_path (void *report_baton,
                                    const char *path,
                                    apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_finish_report (void *report_baton,
                                      apr_pool_t *pool);
 ...
 * this function.
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_abort_report (void *report_baton,
                                     apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_get_commit_editor2 (const svn_delta_editor_t **editor,
                                           void **edit_baton,
                                           svn_repos_t *repos,
                                           svn_fs_txn_t *txn,
                                           const char *repos_url,
 ...
 * @deprecated Provided for backward compatibility with the 1.1 API.
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_get_commit_editor (const svn_delta_editor_t **editor,
                                          void **edit_baton,
                                          svn_repos_t *repos,
                                          const char *repos_url,
                                          const char *base_path,
 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_get_file_revs (svn_repos_t *repos,
                                      const char *path,
                                      svn_revnum_t start,
                                      svn_revnum_t end,
                                      svn_repos_authz_func_t authz_read_func,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_fs_commit_txn (const char **conflict_p,
                                      svn_repos_t *repos,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_fs_begin_txn_for_commit (svn_fs_txn_t **txn_p,
                                                svn_repos_t *repos,
                                                svn_revnum_t rev,
                                                const char *author,
                                                const char *log_msg,
 ...
 *              be called here.
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_fs_begin_txn_for_update (svn_fs_txn_t **txn_p,
                                                svn_repos_t *repos,
                                                svn_revnum_t rev,
                                                const char *author,
                                                apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_fs_lock (svn_lock_t **lock,
                                svn_repos_t *repos,
                                const char *path,
                                const char *token,
                                const char *comment,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_fs_unlock (svn_repos_t *repos,
                                  const char *path,
                                  const char *token,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_fs_get_locks (apr_hash_t **locks,
                                     svn_repos_t *repos,
                                     const char *path,
                                     svn_repos_authz_func_t authz_read_func,
                                     void *authz_read_baton,
 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_fs_change_rev_prop2 (svn_repos_t *repos,
                                            svn_revnum_t rev,
                                            const char *author,
                                            const char *name,
 ...
 * @deprecated Provided for backward compatibility with the 1.0 API.
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_fs_change_rev_prop (svn_repos_t *repos,
                                           svn_revnum_t rev,
                                           const char *author,
                                           const char *name,
                                           const svn_string_t *new_value,
 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_fs_revision_prop (svn_string_t **value_p,
                                         svn_repos_t *repos,
                                         svn_revnum_t rev,
                                         const char *propname,
                                         svn_repos_authz_func_t
 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_fs_revision_proplist (apr_hash_t **table_p,
                                             svn_repos_t *repos,
                                             svn_revnum_t rev,
                                             svn_repos_authz_func_t
                                                        authz_read_func,
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_fs_change_node_prop (svn_fs_root_t *root,
                                            const char *path,
                                            const char *name,
 ...
 * argument descriptions).
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_fs_change_txn_prop (svn_fs_txn_t *txn,
                                           const char *name,
                                           const svn_string_t *value,
                                           apr_pool_t *pool);
 ...
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_node_editor (const svn_delta_editor_t **editor,
                                    void **edit_baton,
                                    svn_repos_t *repos,
 ...
 */
LIBSVN_CLIENT_API svn_repos_node_t *svn_repos_node_from_baton (void *edit_baton);
 ...
 * @since New in 1.1.
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_dump_fs2 (svn_repos_t *repos,
 ...
 * @deprecated Provided for backward compatibility with the 1.0 API.
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_dump_fs (svn_repos_t *repos,
                                svn_stream_t *dumpstream,
                                svn_stream_t *feedback_stream,
                                svn_revnum_t start_rev,
                                svn_revnum_t end_rev,
 ...
 * @since New in 1.2.
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_load_fs2 (svn_repos_t *repos,
                                 svn_stream_t *dumpstream,
                                 svn_stream_t *feedback_stream,
 ...
 * @deprecated Provided for backward compatibility with the 1.0 API.
 */
LIBSVN_CLIENT_API svn_error_t *svn_repos_load_fs (svn_repos_t *repos,
                                svn_stream_t *dumpstream,
                                svn_stream_t *feedback_stream,
                                enum svn_repos_load_uuid uuid_action,
                                const char *parent_dir,
