...
var
  svn_revnum_parse: function(rev: PSvnRevNum; str: PChar; endptr: PPChar): PSvnError; cdecl;
  svn_depth_to_word: function(depth: TSvnDepth): PChar; cdecl;
  svn_depth_from_word: function(word: PChar): TSvnDepth; cdecl;
...
var
  ...
  svn_compat_log_revprops_out: procedure(out author, date, message: PChar; revprops: PAprHash); cdecl;
...
var
  ...
  svn_pool_create_ex_debug: function(parent_pool: PAprPool; allocator: PAprAllocator; file_line: PChar): PAprPool; cdecl;
...
var
  ...
  svn_cstring_casecmp: function(str1, str2: PChar): Integer; cdecl;
...
var
  ...
  svn_xml_parse: function(svn_parser: PSvnXMLParser; buf: PChar; len: TAprSize; is_final: TSvnBoolean): PSvnError; cdecl;
...
var
  ...
  svn_prop_has_svn_prop: function(prop_name: PChar): TSvnBoolean; cdecl;
  svn_prop_is_boolean: function(prop_name: PChar): TSvnBoolean; cdecl;
  ...
  svn_prop_diffs: function(out propdiffs: PAprArrayHeader; target_props, source_props: PAprHash;
    pool: PAprPool): PSvnError; cdecl;
  svn_prop_name_is_valid: function(prop_name: PChar): TSvnBoolean; cdecl;
...
var
  ...
  svn_path_splitext: procedure(out path_root, path_ext: PChar; path: PChar; pool: PAprPool); cdecl; 
  ...
  svn_dirent_is_root: function(dirent: PChar; len: TAprSize): TSvnBoolean; cdecl;
  svn_path_canonicalize: function(path: PChar; pool: PAprPool): PChar; cdecl;
  svn_path_is_canonical: function(path: PChar; pool: PAprPool): TSvnBoolean; cdecl;
  ...
  svn_path_compose: function(components: PAprArrayHeader; pool: PAprPool): PChar; cdecl;
...
var
  svn_mergeinfo_parse: function(out mergeinfo: TSvnMergeInfo; input: PChar; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_mergeinfo_inheritable: function(out inheritable_mergeinfo: TSvnMergeInfo; mergeinfo: TSvnMergeInfo;
    path: PChar; rev_start, rev_end: TSvnRevNum; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_inheritance_to_word: function(inherit: TSvnMergeInfoInheritance): PChar; cdecl;
  svn_inheritance_from_word: function(word: PChar): TSvnMergeInfoInheritance; cdecl;
...
var
  ...
  svn_stream_contents_same: function(out same: TSvnBoolean; stream1, stream2: PSvnStream; pool: PAprPool): PSvnError;
    cdecl;
  svn_stringbuf_from_file2: function(out result: PSvnStringBuf; filename: PChar; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_io_remove_dir2: function(path: PChar; ignore_enoent: TSvnBoolean; cancel_func: TSvnCancelFunc;
  ...
  svn_io_parse_mimetypes_file: function(out type_map: PAprHash; mimetypes_file: PChar; pool: PAprPool): PSvnError;
    cdecl;
  svn_io_detect_mimetype2: function(out mimetype: PChar; afile: PChar; mimetype_map: PAprHash;
    pool: PAprPool): PSvnError; cdecl;
...
var
  ...
  svn_subst_stream_translated_to_normal_form: function(out stream: PSvnStream; source: PSvnStream;
    eol_style: TSvnSubstEolStyle; eol_str: PChar; always_repair_eols: TSvnBoolean; keywords: PAprHash;
    pool: PAprPool): PSvnError; cdecl;
  svn_subst_stream_from_specialfile: function(out stream: PSvnStream; path: PChar; pool: PAprPool): PSvnError; cdecl;
...
var
  ...
  svn_diff_file_output_unified3: function(output_stream: PSvnStream; diff: PSvnDiff; original_path, modified_path,
    original_header, modified_header, header_encoding, relative_to_dir: PChar; show_c_function: TSvnBoolean;
    pool: PAprPool): PSvnError; cdecl;
  ...
  svn_diff_mem_string_output_unified: function(output_stream: PSvnStream; diff: PSvnDiff;
    original_header, modified_header, header_encoding: PChar; original, modified: PSvnString;
    pool: PAprPool): PSvnError; cdecl;
  svn_diff_mem_string_output_merge: function(output_stream: PSvnStream; diff: PSvnDiff;
    original, modified, latest: PSvnString;
    conflict_original, conflict_modified, conflict_latest, conflict_separator: PChar;
    display_original_in_conflict, display_resolved_conflicts: TSvnBoolean; pool: PAprPool): PSvnError; cdecl;
...
type
  ...
  TSvnDeltaEditor = record
    ...
    add_file: function(path: PChar; parent_baton: Pointer; copyfrom_path: PChar; copyfrom_revision: TSvnRevNum;
  ...
  TSvnFileRevHandler = function(baton: Pointer; path: PChar; rev: TSvnRevNum; rev_props: PAprHash;
  ...
  TSvnFileRevHandlerOld = function(baton: Pointer; path: PChar; rev: TSvnRevNum; rev_props: PAprHash;
...
var
  ...
  svn_fs_upgrade: function(path: PChar; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_fs_recover: function(path: PChar; cancel_func: TSvnCancelFunc; cancel_baton: Pointer; pool: PAprPool): PSvnError;
    cdecl;
  ...
  svn_fs_node_created_rev: function(out revision: TSvnRevNum; root: PSvnFSRoot; path: PChar; pool: PAprPool): PSvnError;
    cdecl;
  svn_fs_node_origin_rev: function(out revision: TSvnRevNum; root: PSvnFSRoot; path: PChar; pool: PAprPool): PSvnError;
    cdecl;
...
var
  ...
  svn_repos_create: function(out repos_p: PSvnRepos; path, unused_1, unused_2: PChar; config, fs_config: PAprHash;
    pool: PAprPool): PSvnError; cdecl;
  svn_repos_upgrade: function(path: PChar; nonblocking: TSvnBoolean; start_callback: TSvnReposUpgradeCallback;
  ...
  svn_repos_has_capability: function(repos: PSvnRepos; out has: TSvnBoolean; capability: PChar;
    pool: PAprPool): PSvnError; cdecl;
  ...
  svn_repos_recover3: function(path: PChar; nonblocking: TSvnBoolean; start_callback: TSvnReposRecoverCallback;
  ...
  svn_repos_begin_report2: function(out report_baton: Pointer; revnum: TSvnRevNum; repos: PSvnRepos;
    fs_base, target, tgt_path: PChar; text_deltas: TSvnBoolean; depth: TSvnDepth;
  ...
  svn_repos_begin_report: function(out report_baton: Pointer; revnum: TSvnRevNum; username: PChar; repos: PSvnRepos;
    ...
    cdecl;
  svn_repos_set_path3: function(report_baton: Pointer; path: PChar; revision: TSvnRevNum; depth: TSvnDepth;
  ...
  svn_repos_set_path: function(report_baton: Pointer; path: PChar; revision: TSvnRevNum; start_empty: TSvnBoolean;
    pool: PAprPool): PSvnError; cdecl;
  svn_repos_link_path3: function(report_baton: Pointer; path, link_path: PChar; revision: TSvnRevNum; depth: TSvnDepth;
    start_empty: TSvnBoolean; lock_token: PChar; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_repos_dir_delta2: function(src_root: PSvnFSRoot; src_parent_dir, src_entry: PChar; tgt_root: PSvnFSRoot;
  ...
  svn_repos_get_commit_editor5: function(out editor: PSvnDeltaEditor; out edit_baton: Pointer; repos: PSvnRepos;
    txn: PSvnFSTxn; repos_url, base_path: PChar; revprop_table: PAprHash; callback: TSvnCommitCallback2;
  ...
  svn_repos_deleted_rev: function(fs: PSvnFS; path: PChar; rev_start, rev_end: TSvnRevNum; out deleted: TSvnRevNum;
    pool: PAprPool): PSvnError; cdecl;
  ...
  svn_repos_node_location_segments: function(repos: PSvnRepos; path: PChar; peg_revision, start_rev, end_rev: TSvnRevNum;
  ...
  svn_repos_fs_get_mergeinfo: function(out catalog: TSvnMergeInfoCatalog; repos: PSvnRepos; paths: PAprArrayHeader;
    ...
    authz_read_func: TSvnReposAuthzFunc; authz_read_baton: Pointer; pool: PAprPool): PSvnError; cdecl;
  svn_repos_get_file_revs2: function(repos: PSvnRepos; path: PChar; rev_start, rev_end: TSvnRevNum;
  ...
  svn_repos_fs_get_locks: function(out locks: PAprHash; repos: PSvnRepos; path: PChar;
    authz_read_func: TSvnReposAuthzFunc; authz_read_baton: Pointer; pool: PAprPool): PSvnError; cdecl;
  svn_repos_fs_change_rev_prop3: function(repos: PSvnRepos; rev: TSvnRevNum; author, name: PChar; new_value: PSvnString;
...
var
  ...
  svn_opt_subcommand_help3: procedure(subcommand: PChar; table: PSvnOptSubcommandDesc2; options_table: PAprGetOptOption;
  ...
  svn_opt_parse_revision: function(start_revision, end_revision: PSvnOptRevision; arg: PChar; pool: PAprPool): Integer;
    cdecl;
  svn_opt_parse_revision_to_range: function(opt_ranges: PAprArrayHeader; arg: PChar; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_opt_parse_path: function(out rev: TSvnOptRevision; out truepath: PChar; path: PChar; pool: PAprPool): PSvnError;
    cdecl;
  svn_opt_print_help3: function(os: PAprGetOpt; pgm_name: PChar; print_version, quiet: TSvnBoolean;
    version_footer, header: PChar; cmd_table: PSvnOptSubcommandDesc2; option_table: PAprGetOptOption;
    global_options: PInteger; footer: PChar; pool: PAprPool): PSvnError; cdecl;
...
var
  ...
  svn_cmdline_prompt_user2: function(out result: PChar; prompt_str: PChar; baton: PSvnCmdLinePromptBaton;
    pool: PAprPool): PSvnError; cdecl;
...
type
  ...
  TSvnRaGetClientStringFunc = function(baton: Pointer; var name: PChar; pool: PAprPool): PSvnError; cdecl;
  ...
  TSvnRaReporter3 = record
    ...
    link_path: function(report_baton: Pointer; path, url: PChar; revision: TSvnRevNum; depth: TSvnDepth;
      start_empty: TSvnBoolean; lock_token: PChar; pool: PAprPool): PSvnError; cdecl;
...
var
  ...
  svn_ra_open3: function(out session_p: PSvnRaSession; repos_URL, uuid: PChar; callbacks: PSvnRaCallbacks2;
  ...
  svn_ra_get_session_url: function(ra_session: PSvnRaSession; out url: PChar; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_ra_do_update2: function(session: PSvnRaSession; out reporter: PSvnRaReporter3; out report_baton: Pointer;
    revision_to_update_to: TSvnRevNum; update_target: PChar; depth: TSvnDepth; send_copyfrom_args: TSvnBoolean;
  ...
  svn_ra_do_switch2: function(session: PSvnRaSession; out reporter: PSvnRaReporter3; out report_baton: Pointer;
    revision_to_switch_to: TSvnRevNum; switch_target: PChar; depth: TSvnDepth; switch_url: PChar;
    switch_editor: PSvnDeltaEditor; switch_baton: Pointer; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_ra_do_status2: function(session: PSvnRaSession; out reporter: PSvnRaReporter3; out report_baton: Pointer;
    status_target: PChar; revision: TSvnRevNum; depth: TSvnDepth; status_editor: PSvnDeltaEditor;
    status_baton: Pointer; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_ra_do_diff3: function(session: PSvnRaSession; out reporter: PSvnRaReporter3; out report_baton: Pointer;
    revision: TSvnRevNum; diff_target: PChar; depth: TSvnDepth; ignore_ancestry, text_deltas: TSvnBoolean;
    versus_url: PChar; diff_editor: PSvnDeltaEditor; diff_baton: Pointer; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_ra_stat: function(session: PSvnRaSession; path: PChar; revision: TSvnRevNum; dirent: PPSvnDirEnt;
    pool: PAprPool): PSvnError; cdecl;
  svn_ra_get_uuid2: function(session: PSvnRaSession; out uuid: PChar; pool: PAprPool): PSvnError; cdecl;
  svn_ra_get_uuid: function(session: PSvnRaSession; out uuid: PChar; pool: PAprPool): PSvnError; cdecl;
  svn_ra_get_repos_root2: function(session: PSvnRaSession; out url: PChar; pool: PAprPool): PSvnError; cdecl;
  svn_ra_get_repos_root: function(session: PSvnRaSession; out url: PChar; pool: PAprPool): PSvnError; cdecl;
  svn_ra_get_location_segments: function(session: PSvnRaSession; path: PChar;
  ...
  svn_ra_get_locations: function(session: PSvnRaSession; out locations: PAprHash; path: PChar; peg_revision: TSvnRevNum;
    location_revisions: PAprArrayHeader; pool: PAprPool): PSvnError; cdecl;
  svn_ra_get_file_revs2: function(session: PSvnRaSession; path: PChar; revstart, revend: TSvnRevNum;
  ...
  svn_ra_has_capability: function(session: PSvnRaSession; out has: TSvnBoolean; capability: PChar;
    pool: PAprPool): PSvnError; cdecl;
...
type
  ...
  TSvnWcEntryCallbacks2 = record
    ...
    handle_error: function(path: PChar; err: PSvnError; walk_baton: Pointer; pool: PAprPool): PSvnError; cdecl;
  end;
  ...
  TSvnWcRelocationValidator3 = function(baton: Pointer; uuid, url, root_url: PChar; pool: PAprPool): PSvnError; cdecl;
  ...
  TSvnWcGetFile = function(baton: Pointer; path: PChar; revision: TSvnRevNum; stream: PSvnStream;
    out fetched_rev: TSvnRevNum; out props: PAprHash; pool: PAprPool): PSvnError; cdecl;
  ...
  TSvnWcCanonicalizeSvnPropGetFile = function(mime_type: PPChar; stream: PSvnStream; baton: Pointer;
    pool: PAprPool): PSvnError; cdecl;
...
var
  ...
  svn_wc_adm_open_anchor: function(out anchor_access, target_access: PSvnWcAdmAccess; out target: PChar;
    path: PChar; write_lock: TSvnBoolean; levels_to_lock: Integer; cancel_func: TSvnCancelFunc; cancel_baton: Pointer;
    pool: PAprPool): PSvnError; cdecl;
  ...
  svn_wc_parse_externals_description3: function(out externals_p: PAprArrayHeader; parent_directory, desc: PChar;
  ...
  svn_wc_create_conflict_result: function(choice: TSvnWcConflictChoice; merged_file: PChar;
  ...
  svn_wc_get_ancestry: function(url: PPChar; rev: PSvnRevNum; path: PChar; adm_access: PSvnWcAdmAccess;
    pool: PAprPool): PSvnError; cdecl;
  svn_wc_walk_entries3: function(path: PChar; adm_access: PSvnWcAdmAccess; walk_callbacks: PSvnWcEntryCallbacks2;
  ...
  svn_wc_ensure_adm3: function(path, uuid, url, repos: PChar; revision: TSvnRevNum; depth: TSvnDepth;
    pool: PAprPool): PSvnError; cdecl;
  ...
  svn_wc_get_status_editor3: function(out editor: PSvnDeltaEditor; out edit_baton, set_locks_baton: Pointer;
    out edit_revision: TSvnRevNum; anchor: PSvnWcAdmAccess; target: PChar; depth: TSvnDepth;
  ...
  svn_wc_delete3: function(path: PChar; adm_access: PSvnWcAdmAccess; cancel_func: TSvnCancelFunc; cancel_baton: Pointer;
  ...
  svn_wc_remove_from_revision_control: function(adm_access: PSvnWcAdmAccess; name: PChar;
    ...
    pool: PAprPool): PSvnError; cdecl;
  svn_wc_resolved_conflict3: function(path: PChar; adm_access: PSvnWcAdmAccess;
  ...
  svn_wc_queue_committed: function(out queue: PSvnWcCommittedQueue; path: PChar; adm_access: PSvnWcAdmAccess;
  ...
  svn_wc_process_committed_queue: function(queue: PSvnWcCommittedQueue; adm_access: PSvnWcAdmAccess;
    new_revnum: TSvnRevNum; rev_date, rev_author: PChar; pool: PAprPool): PSvnError; cdecl;
  svn_wc_process_committed4: function(path: PChar; adm_access: PSvnWcAdmAccess; recurse: TSvnBoolean;
    new_revnum: TSvnRevNum; rev_date, rev_author: PChar; wcprop_changes: PAprArrayHeader;
  ...
  svn_wc_process_committed: function(path: PChar; adm_access: PSvnWcAdmAccess; recurse: TSvnBoolean;
    ...
    cdecl;
  svn_wc_crawl_revisions3: function(path: PChar; adm_access: PSvnWcAdmAccess; reporter: PSvnRaReporter3;
  ...
  svn_wc_get_update_editor3: function(out target_revision: TSvnRevNum; anchor: PSvnWcAdmAccess; target: PChar;
    ...
    diff3_cmd: PChar; preserved_ext: PAprArrayHeader; out editor: PSvnDeltaEditor; out edit_baton: Pointer;
  ...
  svn_wc_get_switch_editor3: function(out target_revision: TSvnRevNum; anchor: PSvnWcAdmAccess;
    target, switch_url: PChar; use_commit_times: TSvnBoolean; depth: TSvnDepth;
    ...
    conflict_baton: Pointer; diff3_cmd: PChar; preserved_exts: PAprArrayHeader; out editor: PSvnDeltaEditor;
    out edit_baton: Pointer; ti: PSvnWcTraversalInfo; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_wc_canonicalize_svn_prop: function(out propval_p: PSvnString; porpname: PChar; propval: PSvnString; path: PChar;
  ...
  svn_wc_get_diff_editor4: function(anchor: PSvnWcAdmAccess; target: PChar; callbacks: PSvnWcDiffCallbacks2;
  ...
  svn_wc_diff4: function(anchor: PSvnWcAdmAccess; target: PChar; callbacks: PSvnWcDiffCallbacks2;
  ...
  svn_wc_get_prop_diffs: function(out propchanges: PAprArrayHeader; out original_props: PAprHash; path: PChar;
    adm_access: PSvnWcAdmAccess; pool: PAprPool): PSvnError; cdecl;
  svn_wc_merge3: function(out merge_outcome: TSvnWcMergeOutcome; left, right, merge_target: PChar;
  ...
  svn_wc_merge_props2: function(state: PSvnWcNotifyState; path: PChar; adm_access: PSvnWcAdmAccess; baseprops: PAprHash;
  ...
  svn_wc_cleanup: function(path: PChar; optional_adm_access: PSvnWcAdmAccess; diff3_cmd: PChar;
    cancel_func: TSvnCancelFunc; cancel_baton: Pointer; pool: PAprPool): PSvnError; cdecl;
  svn_wc_relocate3: function(path: PChar; adm_access: PSvnWcAdmAccess; path_from, path_to: PChar; recurse: TSvnBoolean;
  ...
  svn_wc_revert3: function(path: PChar; parent_access: PSvnWcAdmAccess; depth: TSvnDepth; use_commit_times: TSvnBoolean;
  ...
  svn_wc_translated_stream: function(out stream: PSvnStream; path, versioned_file: PChar; adm_access: PSvnWcAdmAccess;
    flags: Cardinal; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_wc_get_ignores: function(out patterns: PAprArrayHeader; config: PAprHash; adm_access: PSvnWcAdmAccess;
    pool: PAprPool): PSvnError; cdecl;
  svn_wc_match_ignore_list: function(str: PChar; list: PAprArrayHeader; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_wc_set_changelist: function(path, changelist: PChar; adm_access: PSvnWcAdmAccess;
...
type
  ...
  TSvnPropListReceiver = function(baton: Pointer; path: PChar; prop_hash: PAprHash; pool: PAprPool): PSvnError; cdecl;
  ...
  TSvnClientGetCommitLog3 = function(out log_msg, tmpfile: PChar; commit_items: PAprArrayHeader; baton: Pointer;
    pool: PAprPool): PSvnError; cdecl;
  ...
  TSvnClientBlameReceiver2 = function(baton: Pointer; line_no: Int64; revision: TSvnRevNum;
    author, date: PChar; merged_revision: TSvnRevNum; merged_author, merged_date, merged_path, line: PChar;
    pool: PAprPool): PSvnError; cdecl;
  ...
  TSvnChangeListReceiver = function(baton: Pointer; path, changelist: PChar; pool: PAprPool): PSvnError; cdecl;
...
var
  ...
  svn_client_checkout3: function(out result_rev: TSvnRevNum; URL, path: PChar; peg_revision, revision: PSvnOptRevision;
  ...
  svn_client_switch2: function(out result_rev: TSvnRevNum; path, url: PChar; peg_revision, revision: PSvnOptRevision;
    depth: TSvnDepth; depth_is_sticky, ignore_externals, allow_unver_obstructions: TSvnBoolean; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
  svn_client_switch: function(out result_rev: TSvnRevNum; path, url: PChar; revision: PSvnOptRevision;
    recurse: TSvnBoolean; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_add4: function(path: PChar; depth: TSvnDepth; force, no_ignore, add_parents: TSvnBoolean;
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_delete: function(out commit_info_p: PSvnCommitInfo; paths: PAprArrayHeader; force: TSvnBoolean;
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_import3: function(out commit_info_p: PSvnCommitInfo; path, url: PChar; depth: TSvnDepth;
  ...
  svn_client_status3: function(result_rev: PSvnRevNum; path: PChar; revision: PSvnOptRevision;
  ...
  svn_client_log: function(targets: PAprArrayHeader; rev_start, rev_end: PSvnOptRevision;
    discover_changed_paths, strict_node_history: TSvnBoolean; receiver: TSvnLogMessageReceiver; receiver_baton: Pointer;
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_blame4: function(path_or_url: PChar; peg_revision, rev_start, rev_end: PSvnOptRevision;
  ...
  svn_client_blame: function(path_or_url: PChar; rev_start, rev_end: PSvnOptRevision; receiver: TSvnClientBlameReceiver;
    receiver_baton: Pointer; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_diff4: function(diff_options: PAprArrayHeader; path1: PChar; revision1: PSvnOptRevision; path2: PChar;
    revision2: PSvnOptRevision; relative_to_dir: PChar; depth: TSvnDepth;
    ignore_ancestry, no_diff_deleted, ignore_content_type: TSvnBoolean; header_encoding: PChar;
  ...
  svn_client_diff: function(diff_options: PAprArrayHeader; path1: PChar; revision1: PSvnOptRevision; path2: PChar;
    ...
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_diff_peg4: function(diff_options: PAprArrayHeader; path: PChar;
    peg_revision, start_revision, end_revision: PSvnOptRevision; relative_to_dir: PChar; depth: TSvnDepth;
    ignore_ancestry, no_diff_deleted, ignore_content_type: TSvnBoolean; header_encoding: PChar;
    outfile, errfile: PAprFile; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_diff_summarize_dup: function(diff: PSvnClientDiffSummarize; pool: PAprPool): PSvnClientDiffSummarize;
    cdecl;
  svn_client_diff_summarize2: function(path1: PChar; revision1: PSvnOptRevision; path2: PChar;
  ...
  svn_client_diff_summarize_peg2: function(path: PChar; peg_revision, start_revision, end_revision: PSvnOptRevision;
  ...
  svn_client_diff_summarize_peg: function(path: PChar; peg_revision, start_revision, end_revision: PSvnOptRevision;
    ...
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_merge3: function(source1: PChar; revision1: PSvnOptRevision; source2: PChar; revision2: PSvnOptRevision;
    target_wcpath: PChar; depth: TSvnDepth; ignore_ancestry, force, record_only, dry_run: TSvnBoolean;
  ...
  svn_client_merge: function(source1: PChar; revision1: PSvnOptRevision; source2: PChar; revision2: PSvnOptRevision;
    ...
    pool: PAprPool): PSvnError; cdecl;
  svn_client_merge_reintegrate: function(source: PChar; peg_revision: PSvnOptRevision; target_wcpath: PChar;
    dry_run: TSvnBoolean; merge_options: PAprArrayHeader; ctx: PSvnClientCtx; pool: PAprpool): PSvnError; cdecl;
  svn_client_merge_peg3: function(source: PChar; peg_revision: PSvnOptRevision; target_wcpath: PChar;
  ...
  svn_client_merge_peg: function(source: PChar; revision1, revision2, peg_revision: PSvnOptRevision;
    target_wcpath: PChar; recurse, ignore_ancestry, force, dry_run: TSvnBoolean; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
  svn_client_suggest_merge_sources: function(out suggestions: PAprArrayHeader; path_or_url: PChar;
    peg_revision: PSvnOptRevision; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_mergeinfo_get_merged: function(out mergeinfo: PAprHash; path_or_url: PChar; peg_revision: PSvnOptRevision;
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_mergeinfo_log_merged: function(path_or_url: PChar; peg_revision: PSvnOptRevision; merge_source_url: PChar;
    ...
    cdecl;
  svn_client_mergeinfo_log_eligible: function(path_or_url: PChar; peg_revision: PSvnOptRevision;
    merge_source_url: PChar; src_peg_revision: PSvnOptRevision; receiver: TSvnLogEntryReceiver; receiver_baton: Pointer;
    discover_changed_paths: TSvnBoolean; revprops: PAprArrayHeader; ctx: PSvnClientCtx; pool: PAprPool): PSvnError;
    cdecl;
  ...
  svn_client_resolved: function(path: PChar; recursive: TSvnBoolean; ctx: PSvnClientCtx; pool: PAprPool): PSvnError;
    cdecl;
  svn_client_resolve: function(path: PChar; depth: TSvnDepth; conflict_choice: TSvnWcConflictChoice; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
  svn_client_copy4: function(out commit_info_p: PSvnCommitInfo; sources: PAprArrayHeader; dst_path: PChar;
  ...
  svn_client_copy2: function(out commit_info_p: PSvnCommitInfo; src_path: PChar; src_revision: PSvnOptRevision;
    dst_path: PChar; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_copy: function(out commit_info_p: PSvnCommitInfo; src_path: PChar; src_revision: PSvnOptRevision;
    dst_path: PChar; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_move5: function(out commit_info_p: PSvnCommitInfo; src_paths: PAprArrayHeader; dst_path: PChar;
    force, move_as_child, make_parents: TSvnBoolean; revprop_table: PAprHash; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
  svn_client_move4: function(out commit_info_p: PSvnCommitInfo; src_path, dst_path: PChar; force: TSvnBoolean;
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_propset3: function(out commit_info_p: PSvnCommitInfo; propname: PChar; propval: PSvnString; target: PChar;
  ...
  svn_client_propget3: function(out props: PAprHash; propname, target: PChar; peg_revision, revision: PSvnOptRevision;
  ...
  svn_client_proplist3: function(target: PChar; peg_revision, revision: PSvnOptRevision; depth: TSvnDepth;
  ...
  svn_client_revprop_list: function(out props: PAprHash; URL: PChar; revision: PSvnOptRevision; out set_rev: TSvnRevNum;
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_export4: function(out result_rev: TSvnRevNum; dir_from, dir_to: PChar;
    peg_revision, revision: PSvnOptRevision; overwrite, ignore_externals: TSvnBoolean; depth: TSvnDepth;
    native_eol: PChar; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_list2: function(path_or_url: PChar; peg_revision, revision: PSvnOptRevision; depth: TSvnDepth;
  ...
  svn_client_cat: function(strm_out: PSvnStream; path_or_url: PChar; revision: PSvnOptRevision; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
  svn_client_add_to_changelist: function(paths: PAprArrayHeader; changelist: PChar; depth: TSvnDepth;
  ...
  svn_client_remove_from_changelists: function(paths: PAprArrayHeader; depth: TSvnDepth; changelists: PAprArrayHeader;
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_get_changelists: function(path: PChar; changelists: PAprArrayHeader; depth: TSvnDepth;
  ...
  svn_client_info2: function(path_or_url: PChar; peg_revision, revision: PSvnOptRevision; receiver: TSvnInfoReceiver;
  ...
  svn_client_root_url_from_path: function(out url: PChar; path_or_url: PChar; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
